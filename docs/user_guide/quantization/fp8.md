...
| Qwen-Image-Edit / Layered | `Qwen/Qwen-Image-Edit-2509`, Qwen-Image-Layered | Yes | Yes | Text-encoder FP8 scoped to the Qwen2.5-VL language model; vision tower and `lm_head` stay BF16 | `img_mlp` | ✅︎ |
